...
- [ ] **Enable Google Gemini models** (e.g. `google/gemini-2.5-pro-exp-03-25:free`) via OpenRouter
...
- [ ] Support file uploads **PDF only for v1 (DOCX & URL ingestion post-launch)** via `/api/v1/docs`
...
- [ ] Show **remaining requests** and **rate-limit reset time** to the user
